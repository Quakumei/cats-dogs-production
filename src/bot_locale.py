...
/apply_video - добавить фильтр к видео (по выбору пользователя)
""",
...
""",
    ...
    "apply_video_send_video": "Отправьте видео, к которому "
    "хотите применить фильтр:",
    "apply_video_start_processing": "Начинаю обработку видео...",
    "apply_video_send_algo": "Выберите функцию:",
    "apply_video_done": "Видео обработано!",
    "file_is_too_big": "Отправьте файл размером не более 20 МБ!",
}
