...
/gt_metrics - вывести метрику качества очистки от шума, используя Ground Truth изображение
""",
...
алгоритма быстрого нелокального среднего фильтрации для удаления шума из изображения.
...
"""
**Нейронная сеть** - метод, основанный на использовании нейронной сети для удаления шума из изображения.
